...
SLOTS = {
    ...
    "asset_work": ("Майно: робота", ["briefcase", "suitcase", "work"]),
    "asset_car": ("Майно: авто", ["car", "car simple", "automobile"]),
    "asset_apartment": ("Майно: квартира", ["buildings", "building apartment", "apartment"]),
    "asset_estate": ("Майно: маєток", ["house", "house line", "home"]),
    "asset_yacht": ("Майно: яхта", ["sailboat", "boat", "ship"]),
    "asset_plane": ("Майно: літак", ["airplane", "airplane tilt", "plane"]),
