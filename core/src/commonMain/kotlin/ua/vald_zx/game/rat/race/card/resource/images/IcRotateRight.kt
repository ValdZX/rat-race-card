...
val Images.IcRotateRight: ImageVector
    get() {
        if (_icRotateRight != null) {
            return _icRotateRight!!
        }
        _icRotateRight = Builder(name = "IcRotateRight", defaultWidth = 24.0.dp, defaultHeight =
...
private var _icRotateRight: ImageVector? = null
