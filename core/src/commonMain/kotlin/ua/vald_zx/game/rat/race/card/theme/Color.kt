...
val LightIfobsColors = AppColors(
...
val LightVividColors = AppColors(
    cash = Color(0xFF00C853),
    positive = Color(0xFF5DE02E),
    negative = Color(0xFFFF4A4A),
    action = Color(0xFFFFC400),
    buy = Color(0xFFFF8A00),
    family = Color(0xFF35B8FF),
    funds = Color(0xFFA45BFF),
    chance = Color(0xFFFFA31A),
    business = Color(0xFF12C97E),
    bigBusiness = Color(0xFF00E5A0),
    smallBusiness = Color(0xFF8CE86B),
    expenses = Color(0xFFFF2D2D),
    store = Color(0xFF00B4FF),
    shopping = Color(0xFF00D8D8),
    deputy = Color(0xFF6E7CFF),
    desire = Color(0xFFFF5BE0),
    divorce = Color(0xFF2E8BFF),
    bankruptcy = Color(0xFFFF3D7F),
    salary = Color(0xFFE8E11A),
    inspection = Color(0xFF3FC7E8),
    exaltation = Color(0xFF8E8CFF),
    love = Color(0xFFFF4D94),
    rest = Color(0xFFB8C4CC),
    start = Color(0xFFFFE000),
    isDark = false,
)

val DarkVividColors = AppColors(
    cash = Color(0xFF00A745),
    positive = Color(0xFF3F9E00),
    negative = Color(0xFFD10020),
    action = Color(0xFFB37700),
    buy = Color(0xFFC75C00),
    family = Color(0xFF1461C7),
    funds = Color(0xFF6E24D1),
    chance = Color(0xFFB36400),
    business = Color(0xFF009266),
    bigBusiness = Color(0xFF00A377),
    smallBusiness = Color(0xFF4F9927),
    expenses = Color(0xFFD1001F),
    store = Color(0xFF007CB3),
    shopping = Color(0xFF008C8B),
    deputy = Color(0xFF3A40D1),
    desire = Color(0xFFC200B0),
    divorce = Color(0xFF0F59D1),
    bankruptcy = Color(0xFFC20055),
    salary = Color(0xFF8C7C00),
    inspection = Color(0xFF007D8A),
    exaltation = Color(0xFF5B58D1),
    love = Color(0xFFCC0062),
    rest = Color(0xFF56636F),
    start = Color(0xFF998400),
    isDark = true,
)

val DarkIfobsColors = AppColors(
