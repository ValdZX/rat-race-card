...
val eventStoreCards = mapOf(
    ...
    101 to BoardCard.EventStore.Land(
        description = "Земля в межах міста — «на вагу золота». Бізнес активно викуповує ділянки. Кожен власник землі може продати її за ціною.",
        price = 75000,
    ),
    102 to BoardCard.EventStore.Land(
        description = "Земля в межах міста — на вагу золота. Кожен метр можна використовувати максимально ефективно. Будівельні компанії скуповують землю.",
        price = 50000,
    ),
    103 to BoardCard.EventStore.Land(
        description = "Земля в межах міста стає стратегічним ресурсом. Будівельні компанії скуповують ділянки.",
        price = 40000,
    ),
    104 to BoardCard.EventStore.Land(
        description = "Земля в межах міста — на вагу золота. Будівельні компанії скуповують землю по $20 000 за сотку.",
        price = 20000,
    ),
    105 to BoardCard.EventStore.Land(
        description = "Земля в межах міста — стабільно зростає в ціні. Кожен метр можна вигідно використовувати.",
        price = 60000,
    ),
    106 to BoardCard.EventStore.Land(
        description = "Земля в межах міста — попит продовжує зростати. Будівельні компанії скуповують ділянки ще дорожче.",
        price = 30000,
    ),
    107 to BoardCard.EventStore.Reelection(
        description = "Ура-а-а! У вашій країні знову проходять перевибори у Верховну Раду, а також обласні вибори. Якщо у вас є підкуплені депутати — поверніть їх у ігрове поле, вони вже депутати!",
    ),
    108 to BoardCard.EventStore.Announcement(
        description = "В країні призначено нового міністра МВС. За новим методом боротьби зі злочинністю зросте попит на землю біля МВС. Власники землі можуть вигідно продати її як «золоту».",
    ),
    109 to BoardCard.EventStore.Announcement(
        description = "У країні призначено нового генерального прокурора! Вот-вот почнеться показова боротьба з корупцією. Якщо у вас є бізнес або земля — приготуйтеся до перевірок.",
    ),
